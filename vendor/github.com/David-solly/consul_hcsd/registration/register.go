...
func RegisterService(consulAddress, consulPort, advertiseAddress, advertisePort, healthPort, serviceID, serviceName string, serviceTags []string) (registrar sd.Registrar) {
	...
	asr := api.AgentServiceRegistration{
		ID:      serviceID + strconv.Itoa(num), //unique service ID
		Name:    serviceName,
